...
mod_wallpaper_select_ubuntu_prepare () {
	...
	# wallpaper-select-hsetroot ubuntu_prepare
...
mod_wallpaper_select_ubuntu_prepare_install_package () {
	...
	#echo "sudo apt-get install hsetroot fzf ueberzug"
	#sudo apt-get install hsetroot fzf ueberzug

}

##
## * https://discover.ubuntu.org/packages/hsetroot
