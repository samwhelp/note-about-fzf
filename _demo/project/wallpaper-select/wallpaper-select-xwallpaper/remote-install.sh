...
# * https://github.com/samwhelp/note-about-fzf/blob/gh-pages/_demo/project/wallpaper-select/wallpaper-select-xwallpaper/remote-install.sh
# * https://github.com/samwhelp/note-about-fzf/blob/gh-pages/_demo/project/wallpaper-select/wallpaper-select-xwallpaper/wallpaper-select-xwallpaper
# * https://raw.githubusercontent.com/samwhelp/note-about-fzf/gh-pages/_demo/project/wallpaper-select/wallpaper-select-xwallpaper/wallpaper-select-xwallpaper
...
## $ export DEBUG_WALLPAPER_SELECT_INSTALL=true
is_debug () {
	if [ "$DEBUG_WALLPAPER_SELECT_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="wallpaper-select-xwallpaper-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-fzf/blob/gh-pages/_demo/project/wallpaper-select/wallpaper-select-xwallpaper/wallpaper-select-xwallpaper
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-fzf/gh-pages/_demo/project/wallpaper-select/wallpaper-select-xwallpaper/wallpaper-select-xwallpaper'


	THE_TARGET_FILE_NAME="wallpaper-select-xwallpaper"
